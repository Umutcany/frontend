  ...
  <div class="form-container">
    <form>
      ...
      <div class="form-group">
        ...
        <input type="url" id="urun_resim" v-model="newProduct.urun_resim" />
      </div>
      ...
      <div class="form-group">
        ...
        <input
          type="number"
          id="urun_fiyat"
          v-model.number="newProduct.urun_fiyat"
          required
        />
      </div>
      ...
      <div class="form-group">
        ...
        <textarea
          id="urun_aciklama"
          v-model="newProduct.urun_aciklama"
          required
        ></textarea>
      </div>
